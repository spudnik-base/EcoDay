    ...
    <Card>
      ...
      <div className="border-t border-rule mt-4 pt-3">
        ...
        <p className="font-mono text-[10px] text-ink3 leading-relaxed mb-2">
          Wipes all data on this device, both stream and meadow. Use this only
          when handing the device to a fresh group at the start of a new
          cohort.
        </p>
        <button
          onClick={handleReset}
